...
$sql = "SELECT a.*, c.department FROM appointments a 
        JOIN counselors c ON a.counselor_id=c.counselor_id
        WHERE a.student_id=$user_id ORDER BY appointment_date DESC";
...
<table class="table table-bordered">
  <thead>
    <tr><th>Date</th><th>Time</th><th>Counselor</th><th>Concern</th><th>Status</th></tr>
  </thead>
  <tbody>
    ...
    } else echo "<tr><td colspan='5'>No appointments found</td></tr>"; ?>
  </tbody>
</table>
        </div>
      </div>
