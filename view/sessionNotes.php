...
$sql = "SELECT s.*, c.department FROM sessions s 
        JOIN counselors c ON s.counselor_id=c.counselor_id
        WHERE s.student_id=$user_id ORDER BY session_date DESC";
...
<table class="table table-bordered">
  <thead>
    <tr><th>Date</th><th>Time</th><th>Counselor</th><th>Notes</th><th>Recommendation</th><th>Outcome</th></tr>
  </thead>
  <tbody>
    ...
    } else echo "<tr><td colspan='6'>No sessions yet</td></tr>"; ?>
  </tbody>
</table>
        </div>
      </div>
